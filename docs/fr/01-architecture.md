# 1. Architecture — Bitcoin Dev Kit

Ce dépôt rassemble les composants de référence consacrés à la construction de portefeuilles Bitcoin, les descripteurs et la synchronisation de chaîne.
...
[Chapitre suivant : Descripteurs, adresses et transactions](02-descripteurs-adresses-et-transactions.md)
